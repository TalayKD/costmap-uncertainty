...
def vis_imglist(outvidfile, imglist, rgbmaplist, heightmaplist, cmds, vels, costs):
    imgvissize = (512, 256)
    mapvissize = (256, 256)
    dt = 0.5
...
def vis_low_score_data():
    ...
    imglist_all, rgbmaplist_all, heightmaplist_all, cmds_all, vels_all, costs_all = [], [], [], [], [], []
    for traj in trajlist:
        ...
        costs = np.load(trajdir + 'cost2/costs.npy')
    ...
    vis_imglist(outvidfile, imglist_all, rgbmaplist_all, heightmaplist_all, cmds_all, vels_all, costs_all)
